...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">{{ $discount->code }}</li>
                        ...
                        <div class="card card-success card-outline">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id="txtCode" type="text" name="code" value="{{ old('code',$discount->code) }}" class="form-control @error('code') is-invalid @enderror" placeholder="Discount Code" >
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="desc" id="txtDesc" rows="3" class="form-control @error('desc',$discount->desc) is-invalid @enderror">{{ old('desc') }}</textarea>
                                    @error('desc')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
