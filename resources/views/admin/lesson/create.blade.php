                ...
                <div class="card card-success card-outline">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="txtTitle" type="text" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Title" >
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <input id="txtSlug" type="text" name="slug" value="{{ old('slug') }}" class="form-control @error('slug') is-invalid @enderror" placeholder="Customize Slug" >
                            @error('slug')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="txtLessonVideoURL">Lesson Video URL</label>
                            <input id="txtLessonVideoURL" type="text" name="lesson_video_url" value="{{ old('lesson_video_url') }}" class="form-control @error('lesson_video_url') is-invalid @enderror" placeholder="Enter URL" >
                        ...
                        {{-- <div class="form-group">
                            ...
                            <div class="custom-file">
                                <input name="lesson_video" type="file" class="custom-file-input @error('lesson_video') is-invalid @enderror" id="inpLessonVideo" accept="video/*" >
